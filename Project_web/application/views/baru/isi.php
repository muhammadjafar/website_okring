...
<html lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo base_url(); ?>tugas/images/ico/favicon.ico">
    </head>
    ...
    <body>
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container">
                    <a href="#" class="brand">
                        <img src="<?php echo base_url(); ?>tugas/images/Logo web2.png" width="30" height="50" alt="Logo" />
